...
?>
    <?php
    $acha = mysqli_query($conn, "SELECT u.nome, u.foto, u.unique_id, c.id_user, c.id_consulta, c.horario, c.realizada, c.id_psic, c.pago, c.tipo_pagamento FROM psicologos AS u INNER JOIN consulta AS c ON u.unique_id = c.id_psic  WHERE id_user = '$id' AND realizada = 0");
