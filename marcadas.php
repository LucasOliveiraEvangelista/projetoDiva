...
<head>
    ...
    <title><?php echo "Consultas marcadas ($marcadas)";?></title>
...
?>
    <?php
    $acha = mysqli_query($conn, "SELECT u.nome, u.foto, u.unique_id, c.id_user, c.id_consulta, c.horario, c.realizada, c.id_psic, c.pago, c.tipo_pagamento   FROM cad_usuario AS u INNER JOIN consulta AS c ON u.unique_id = c.id_user  WHERE id_psic = '$id' AND realizada = 0");
