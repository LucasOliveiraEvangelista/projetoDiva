<?php
	...
	if($registros>0){
		...
		$query = "UPDATE psicologos SET nome='$nome', nascimento='$data_nasc', telefone='$telefone', sexo='$sexo', cep='$cep', tempo_experiencia='$ano', tempo_consulta='$tempo', local ='$local', valor='$valor', estado='$estado', texto='$texto', idioma='$idioma', remarcacao='$remarca', resumo='$resumo' WHERE unique_id = $id";
